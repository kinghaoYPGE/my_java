package com.ssm.resume.controller;

import com.ssm.resume.model.Resume;
import com.ssm.resume.service.IResumeService;
import com.ssm.resume.tools.AjaxResult;
import com.ssm.resume.tools.PDFUtil;
...
// 采用前后端分离模式，使用REST ful controller，返回json到页面
@RestController
