package com.myspringboot.demo.aop;
...
public class SpringbootAop {
    ...
    // 设置切点
    @Pointcut(value = "execution(* com.myspringboot.demo..*.run(..))")
    public void aop(){
    }
    ...
    public Advisor advisor() {
        ...
        aspectJExpressionPointcut.setExpression("execution(* com.myspringboot.demo.service..*.save(..))");
        //返回aop切面，切面=切点+通知
